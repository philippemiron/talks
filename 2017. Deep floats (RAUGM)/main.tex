...
Then, project $f(x)$ on the basis $V_N$, called Ulam basis \parencite{ulam1960}:
\begin{equation}
...
This motivates the idea that regions where trajectories converge and their basins of attraction are encoded in the eigenvectors of the transition matrix $P$ with eigenvalues ($\lambda \approx 1$) \parencite{froyland2014well}.
}
...
\frame{\frametitle{Comparison with experimental data \parencite{ledwell2016dispersion}}
