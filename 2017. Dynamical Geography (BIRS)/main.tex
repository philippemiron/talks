...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.35\textwidth]{figures/henon-solution.png}
\end{figure}
...
\begin{figure}
    \centering
    \subfloat{{\includegraphics[width=0.35\textwidth]{figures/henon-attr.png} }}%
    \qquad
    \subfloat{{\includegraphics[width=0.35\textwidth]{figures/henon-basin.png} }}%
\end{figure}
}
