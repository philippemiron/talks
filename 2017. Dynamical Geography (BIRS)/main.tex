...
\node[at=(current page.south west), anchor=south west] {%
 \includegraphics[width=.35\textwidth]{figures/carthe.png} 
};
\node[at=(current page.south east), anchor=south east] {
 \includegraphics[width=.3\textwidth]{figures/GoMRi.png} 
};
\end{tikzpicture}
}


% justify text in all frame
\usepackage{ragged2e}
\usepackage{etoolbox}
\usepackage{tikz}
...
\frame{\frametitle{Biodegradable drifters \citep[][University of Miami]{novelliDrift2017}}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[angle=180,width=0.5\textwidth]{figures/Drifters}
\end{figure}
}
...
\frame{\frametitle{Approximation of an attractor \citep{dellnitz1997almost,Froyland-01}}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.35\textwidth]{figures/henon/henon-solution.png}
\end{figure}
...
\begin{figure}
    \centering
    \subfloat{{\includegraphics[width=0.35\textwidth]{figures/henon/henon-attr.png} }}%
    \qquad
    \subfloat{{\includegraphics[width=0.35\textwidth]{figures/henon/henon-basin.png} }}%
\end{figure}
}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[scale=0.9]{figures/fig02}
  \label{fig:push_density}
\end{figure}
}
}

\frame{\frametitle{Transition matrix \citep{froyland2001extracting}}
\begin{itemize}
    \item Probabilistic approach known as Ulam's method \citep{ulam1960}
...
\frame{\frametitle{Markov Chain and eigenvectors method \citep{froyland2014well}}
\begin{itemize}
...
All drifters trajectory start at the same time (Autonomous system) and we construct the transition matrix by looking where drifters end up \SI{2}{days} later (bins size, data).
   \begin{figure}
      \includegraphics[width=0.7\linewidth]{figures/fig03b}
    \end{figure}
}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/fig04b}
  \label{fig:tarjan}
\end{figure}
}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/fig05b}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/fig06}
  \label{fig:r_eig}
\end{figure}
}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/fig07}
  \label{fig:l_eig}
\end{figure}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/fig08}
  \label{fig:r_to_l}
\end{figure}
}
\fi
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/fig09}
  \label{fig:dyngeo}
\end{figure}
}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{figures/oilrigs/fig}
  \label{fig:oilrigs}
\end{figure}
}
\fi
...
\begin{itemize}
    ...
    \item Supported by independent observations of a westward mean flow \citep{sturges2016mean}
